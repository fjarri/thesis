...
\label{thm:fpe-sde:ito-formula:func-ito-f}
	...
	\begin{eqn*}
		\upd f_j = \mathcal{A}_j dt + \sum_{l=1}^L \mathcal{B}_{jl} \upd Q_l,
	\end{eqn*}
	...
	\begin{eqn*}
		...
		\right).
	\end{eqn*}
	Here $f_j$, $\mathcal{A}_j$, $\mathcal{B}_{jl}$, $W$, $\mathbb{L}$, and $Q_l$ are defined the same as in \thmref{fpe-sde:corr:fpe-sde-func}.
\end{theorem}
\begin{proof}
