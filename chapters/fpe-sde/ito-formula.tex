...
Finally, we can use the multi-component reformulation to derive the It\^o formula in a functional form for the set of \abbrev{sde}s from \thmref{fpe-sde:corr:fpe-sde-func}.
...
Alternatively, the functional It\^o formula can be written in a matrix form as
\begin{eqn}
	\upd \mathcal{F}[\fvec]
	={} & \int \upd\xvec^\prime \left(
		2 \Real \left(
