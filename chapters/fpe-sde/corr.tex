...
Of course, in order to produce a real-valued $\upd W/\upd t$ in the left part, an \abbrev{fpe} must have a particular form.
...
In order to use \lmmref{fpe-sde:corr:fpe-sde-real}, we need to join variables $\xvec$ and $\yvec$ into one variable vector $\zvec \equiv \xvec \oplus \yvec$.
...
Truly general form of an \abbrev{fpe} would be
\begin{eqn}
	\frac{\upd W}{\upd t}
