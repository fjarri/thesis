...
Of couse, in order to produce a real-valued $\upd W/\upd t$ in the left part, a \abbrev{fpe} must have a particular form.
...
We will calculate $s_j$ with $j$ belonging to the $\xvec$ and the $\yvec$ part of coordinate space separately.
\begin{eqn}
	s_j^{(x)}
	= \frac{1}{4} \Trace{
		\begin{pmatrix}
...
Truly general form of a \abbrev{fpe} would be
\begin{eqn}
	\frac{\upd W}{\upd t}
