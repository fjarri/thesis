...
\label{def:formalism:mc-wigner:w-transformation}
	...
	\begin{eqn*}
		& \mathcal{W} :: \left( \mathbb{R}^D \rightarrow \bigotimes_{j=1}^C \mathbb{H}_{\restbasis_j} \right)
			\rightarrow \bigotimes_{j=1}^C \mathbb{F}_{\restbasis_j}
			\rightarrow \mathbb{C} \\
		& \mathcal{W}[\hat{A}]
...
\label{def:formalism:mc-wigner:w-functional}
	...
	\begin{eqn*}
		& W :: \bigotimes_{j=1}^C \mathbb{F}_{\restbasis_j} \rightarrow \mathbb{C} \\
		& W [\bPsi, \bPsi^*]
	...
	\begin{eqn*}
		& \chi_W :: \bigotimes_{j=1}^C \mathbb{F}_{\restbasis_j} \rightarrow \mathbb{R} \\
		& \chi_W [\bLambda, \bLambda^*]
