...
\end{eqn}
Field operators have type $\Psiop_j \in (\mathbb{R}^D \rightarrow \mathbb{H}_j) = \mathbb{FH}_j$. \todo{As far as I understand $\mathbb{H}_1 \otimes \ldots \otimes \mathbb{H}_C \equiv \mathbb{H}$, where $\rho \in \mathbb{H}$.}
