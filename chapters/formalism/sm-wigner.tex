...
\label{def:formalism:sm-wigner:w-transformation}
	...
	\end{eqn*}
	\todo{Is the result actually real, or is it complex? M.b. real for density matrix?}
\end{definition}

It is easy to demonstrate that Wigner and Weyl transformations define a bijection $\mathbb{H} \leftrightarrow (\mathbb{C} \rightarrow \mathbb{R})$ \todo{at least, for Hilbert-Schmidt operators and square-integrable functions~\cite{Cahill1969}}.
