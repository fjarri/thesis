...
The major part of the usefullness of the Wigner transformation (paired with the Wigner truncation) is that it produces a \abbrev{fpe} in a special form, which can be further transformed to a set of \abbrev{sde}s, with the Wigner function playing the role of a probability distribution.
