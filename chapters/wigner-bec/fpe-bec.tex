...
It is interesting to get an expression for time dependence of some simple observables using SDEs~\eqnref{wigner-bec:fpe-bec:sde} and It\^{o}'s formula (\thmref{wigner-bec:ito-formula:func-ito-f}).
...
\begin{theorem}
	Given a set of SDEs~\eqnref{wigner-bec:fpe-bec:sde}, the population changes in time as
	\begin{eqn*}
		\frac{dN_i}{dt}
		=
	\end{eqn*}
