...
With the assumption of the state being coherent, the simple condition for truncation --- i.e., omitting terms of $\mathcal{O}(1/N_j^2)$ --- can be shown to be~\cite{Sinatra2002}
\begin{eqn}
	N_j \gg |\restbasis_j|,
\end{eqn}
