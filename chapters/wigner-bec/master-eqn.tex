...
The model is valid if the trap is state-selective, or the collision is highly exotermic, such that the resulting particles are able to move rapidly away.
