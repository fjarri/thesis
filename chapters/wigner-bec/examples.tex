...
We will first consider a simple case with a single component \abbrev{bec}, with a 3-body loss process and no unitary evolution (the same as described in~\cite{Norrie2006a}).
