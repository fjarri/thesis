...
\begin{figure}
    \centerline{%
    \includegraphics{figures_generated/exact/squeezing_nocc.pdf}%
    \includegraphics{figures_generated/exact/squeezing_cc.pdf}}
...
The Wigner method shows good agreement with the exact results; the growing sampling error can be reduced to a desirable extent by using more simulation trajectories.
