...
\begin{eqn}
    \bar{A}_{\mathrm{SU(2)-Q}}
    = \int A_{\mathrm{SU(2)-Q}}(\zvec) \upd^2 \zvec,
\end{eqn}
where
\begin{eqn}
    A_{\mathrm{SU(2)-Q}}
...
\begin{figure}
    ...
    \caption{
    Correlations for the different parts of the inequality~\eqnref{bell-ineq:ghz:general-ineq-M2}, in case of positive-P \textbf{(a, b)} and SU(2)-Q \textbf{(c, d)} representations, $10^8$ samples.}
...
\begin{figure}
    ...
    \caption{
    Violations of the inequality~\eqnref{bell-ineq:ghz:general-ineq} for multi-particle \abbrev{ghz} states.
    \textbf{(a)} Simulated violation using SU(2)-Q representation.
