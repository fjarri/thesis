...
We will use these theorems to obtain a correspondence between operator evolution equations and functional derivatives of a classical field $\Psi$, which act on the Wigner functional instead of the quantum density matrix.
...
The simplest non-trivial element of a Hamiltonian is the second-order operator $\Psiop_j^\dagger \Psiop_k$, which may describe, for instance, a potential or a coupling field.
