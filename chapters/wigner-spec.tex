...
The next usual term in \abbrev{bec} Hamiltonians is a fourth order nonlinear interaction term.
...
\label{thm:wigner-spec:w-commutator2}
    ...
    \begin{eqn*}
        ...
        & = \int \upd\xvec \int \upd\xvec^\prime \left(
            ...
            \right) \right . \\
        &   \left. + \frac{\fdelta}{\fdelta \Psi_j^{\prime*}} \left(
            ...
            \right) \right. \\
        &   \left. + \frac{\fdelta}{\fdelta \Psi_k^\prime} \left(
            ...
            \right) \right .\\
        &   \left. + \frac{\fdelta}{\fdelta \Psi_k^*} \left(
...
\label{thm:wigner-spec:w-losses}
    ...
    \begin{eqn*}
        \mathcal{W} \left[ \int \upd\xvec \hat{\mathcal{L}}_{\lvec} [\hat{A}] \right]
        = \int \upd\xvec
