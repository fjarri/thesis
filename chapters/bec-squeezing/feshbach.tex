...
\begin{figure}
    ...
    \caption{
    Wigner simulations of squeezing in the vicinity of $9.1\un{G}$ Feshbach resonance in \Rb with the varying external magnetic field strength.
...
The resulting time dependence of the degree of squeezing for different interaction strengths is shown in~\figref{bec-squeezing:feshbach:squeezing}.
Feshbach tuning to $a_{12} = 90.0\,r_B$ ensures the best squeezing of the four variants ($-6\un{dB}$ at $40\un{ms}$), whereas long lasting squeezing is predicted for the variant with $a_{12} = 95.0\,r_B$.
