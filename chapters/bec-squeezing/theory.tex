...
Note that in this thesis we only consider the squeezing along the direction orthogonal to the total spin, as was originally introduced, but a more general definition is also possible \todo{reference two-directional squeezing}.
