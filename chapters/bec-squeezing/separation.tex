...
The simulation used a $16\times16\times128$ spatial grid, $20,000$ time steps and $12,800$ stochastic trajectories (to collect more data for \figref{bec-squeezing:separation:cloud}; the estimation of the optimum squeezing would require much less than that).
