...
It should be noted that because of the large number fluctuations, the squeezing definition used in the experiment actually corresponds to the one introduced by He \textit{et~al}~\cite{He2012a}, with variable particle number.
