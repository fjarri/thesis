...
\begin{figure}
    ...
    The $yz$ plane illustrates the squeezing achieved in the experiment: the variance $\Delta^2 \hat{S}_\theta$ is connected to the standard deviation of the distribution $\sigma_\theta$ in the direction $\theta$ (shown with two arrows) as $\Delta^2 \hat{S}_\theta = \sigma_\theta^2$.}
...
The projections of the resulting probability distribution on three orthogonal planes is shown in~\figref{bec-squeezing:separation:cloud}.
