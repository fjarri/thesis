...
\begin{split}
	...
	& = \delta_{n m_1} \hat{a}_{m_2} + \delta_{n m_2} \hat{a}_{m_1}, \\
	[ \hat{a}_n, \hat{a}_{m_1}^\dagger \hat{a}_{m_2}^\dagger \hat{a}_{m_3}^\dagger ]
	& = \delta_{n m_1} \hat{a}_{m_2} \hat{a}_{m_3}
	+ \delta_{n m_2} \hat{a}_{m_1} \hat{a}_{m_3}
	+ \delta_{n m_3} \hat{a}_{m_1} \hat{a}_{m_2}, \\
	& \ldots
\end{split}
\end{equation*}
