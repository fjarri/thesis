...
\begin{eqn}
	...
	& = \left( \prod_{\nvec \in \restbasis} \sum_{r_{\nvec}, s_{\nvec}} \right)
		...
		\rangle.
\end{eqn}
Same as in \lmmref{wigner:sm:moments-from-chi}, differentiating the resulting expression will leave only term with required $r_{\nvec}$ and $s_{\nvec}$.
\end{proof}
