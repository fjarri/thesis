...
along with the notation $\upd f/\upd z$.
...
\label{lmm:c-numbers:fourier-of-moments}
	...
	\begin{eqn*}
		...
		= \pi^2
			\left( -\frac{\upd}{\upd \beta^*} \right)^r
			\left( \frac{\upd}{\upd \beta} \right)^s
...
\label{lmm:c-numbers:zero-delta-integrals}
	...
	\begin{eqn*}
		\int \upd^2 z
			\frac{\upd}{\upd z} \left(
				f(z)
				\left( \frac{\upd}{\upd z} \right)^s
				\left( -\frac{\upd}{\upd z^*} \right)^r
