...
Both \abbrev{gpe} and truncated Wigner simulations in this section and \secref{bec-noise:phase-noise} used $80,000$ time steps for \figref{bec-noise:visibility:visibility-long} and $200,000$ time steps for \figref{bec-noise:visibility:visibility-long}).
