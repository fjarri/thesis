...
\begin{figure}
\begin{center}
\subfloat[Miscible regime]{\includegraphics[width=0.5\textwidth]{figures/mean-field/two_comp_gs_miscible.eps}}
\subfloat[Immiscible regime]{\includegraphics[width=0.5\textwidth]{figures/mean-field/two_comp_gs_immiscible.eps}}
\end{center}
\caption{Two-component ground state for miscible and immiscible regimes of \Rb{} \abbrev{bec} with $N_1 = N_2 = 40,000$ atoms in states ${\ket{F=1,\, m_F=-1}}$ and ${\ket{F=2,\, m_F=+1}}$.
...
\begin{figure}
\begin{center}
\subfloat[100,000 atoms]{\includegraphics[width=0.5\textwidth]{figures/mean-field/ground_states_100k.eps}}
\subfloat[1,000 atoms]{\includegraphics[width=0.5\textwidth]{figures/mean-field/ground_states_1k.eps}}
\end{center}
...
\figref{bec-noise:mean-field:tf-vs-accurate} shows the density along the z axis for both cases: for $10^5$ atoms the Thomas-Fermi approximation is very close to the numerically calculated ground state, and for $10^3$ atoms it differs significantly, as expected.
