...
\begin{figure}
\begin{center}
\subfloat[Miscible regime]{\includegraphics[width=0.5\textwidth]{figures_generated/mean_field/two_comp_gs_miscible.pdf}}
\subfloat[Immiscible regime]{\includegraphics[width=0.5\textwidth]{figures_generated/mean_field/two_comp_gs_immiscible.pdf}}
\end{center}
\caption{Two-component ground state for miscible and immiscible regimes of \Rb{} \abbrev{bec} with $N_1 = N_2 = 40,000$ atoms of states ${\ket{F=1,\, m_F=-1}}$ (solid blue lines) and ${\ket{F=2,\, m_F=+1}}$ (dashed red lines).
The lines show the particle density in a \abbrev{3d} harmonic trap with the frequencies $f_x = f_y = 97.6\un{Hz},\,f_z = 11.96\un{Hz}$, integrated over $x$ and $y$ axes.
...
As an example, \figref{bec-noise:mean-field:two-comp-gs} shows the axial projection of the two-component ground state for an equal mix of two states of \Rb{} \abbrev{bec}.
...
\begin{figure}
\begin{center}
\subfloat[100,000 atoms]{\includegraphics[width=0.5\textwidth]{figures_generated/mean_field/one_comp_gs_large.pdf}}
\subfloat[1,000 atoms]{\includegraphics[width=0.5\textwidth]{figures_generated/mean_field/one_comp_gs_small.pdf}}
\end{center}
\caption{Numerically calculated (solid blue lines) and Thomas-Fermi approximated (dashed red lines) ground states for a one-component \Rb{} \abbrev{bec} of (a) 100,000 atoms, and (b) 1,000 atoms.}
...
\figref{bec-noise:mean-field:tf-vs-accurate} shows the particle density integrated over transverse ($x$ and $y$) axes for both cases: for $10^5$ atoms the Thomas-Fermi approximation is very close to the numerically calculated ground state, and for $10^3$ atoms it differs significantly, as expected.
