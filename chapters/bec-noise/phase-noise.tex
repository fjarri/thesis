...
\begin{figure}
    %\includegraphics{figures/phase_noise/ramsey_visibility.eps}
...
The mean-field model predicts the full recover of the visibility even at very long evolution times, which is inconsistent with the experiment, as seen in~\figref{bec-noise:phase-noise:spin-echo-visibility}.
