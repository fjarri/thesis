...
This is a dominant relaxation mechanism in \abbrev{bec} systems, and is often ignored or (incorrectly) approximated using linear loss terms.}
...
and is important in high-accuracy simulations. Such corrections --- both in the drift and noise --- are relevant to topics like \abbrev{epr} correlations, entanglement and quantum squeezing in the presence of nonlinear reservoirs, a topic of increasing importance in areas ranging from quantum optics and \abbrev{bec} physics to nanomechanical oscillators~\cite{Chaturvedi1977,Reid1986a,Rabl2004}.}
