...
We reduce the initial master equation for bosonic field operators to a system of stochastic differential equations, which have significantly lower computational complexity.
