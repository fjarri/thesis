...
\charef{bell-ineq} stands a bit aside, since it mostly makes use of the different quasiprobability method, Husimi Q-function (in its SU(2) variation).
...
\appref{fpe-sde} contains several theorem which deal with the equivalence correspondence between Fokker-Planck equation (\abbrev{fpe}) and a set of \abbrev{sde}s, for complex variables and functional form.
