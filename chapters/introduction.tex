...
We perform a simple comparison of the multimode Wigner with an exact expansion in number states in \secref{wigner-bec:mm}.
...
We also give an example of usage of the formalism for a single-component multi-mode \abbrev{bec}.
...
\appref{fpe-sde} contains several theorems, which describe the equivalence correspondence between Fokker-Planck equation (\abbrev{fpe}) and a set of \abbrev{sde}s, for complex variables and functional form.
