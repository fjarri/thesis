...
If we impose an energy cutoff $\epsilon_{\mathrm{cut}}$ and only take into account low-energy modes,
...
Interaction part of hamiltonian~\eqnref{wigner:hamiltonian} then can be rewritten as:
\begin{equation*}
...
$a_{ij}$ is the $s$-wave scattering length in three dimensions \todo{generalize it for $D$ dimentsions}.
