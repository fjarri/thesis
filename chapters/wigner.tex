...
Shape of the module of restricted delta function~\eqnref{formalism:func-calculus:restricted-delta} for two different basis sets and two different cutoffs is shown in~\figref{wigner:restricted-delta}.
