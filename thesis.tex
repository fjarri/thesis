...
\usepackage[pdfa, bookmarks, bookmarkstype=toc, unicode, pdfencoding=auto, backref=page, breaklinks, pdftitle={PhD thesis: \plainthesisname}, pdfauthor={Bogdan Opanchuk}, colorlinks, urlcolor=mainblue, citecolor=darkred, linkcolor=mainblue]{hyperref}
